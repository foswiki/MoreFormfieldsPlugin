...
#
# MoreFormfieldsPlugin is Copyright (C) 2023-2026 Michael Daum http://michaeldaumconsulting.com
#
...
sub renderForEdit {
  ...
  foreach my $key (qw(type mask pattern min max radix scale lazy from to autofix display)) {
